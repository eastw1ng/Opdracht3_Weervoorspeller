...
VisueelScherm::VisueelScherm( WeerData* weerData ){
	...
	//maak een listbox waar update en textueelknop aan toegevoegd worden
...
void VisueelScherm::update(){
	...
	//Tekent de balken
	offy+=3;
	if(weerData->minimumtemperatuur[0]>0){ //Als de temperatuur negatief is, maak het zo dat de balken ook negatief staan
	...
	offy+=7;
	if(weerData->minimumtemperatuur[1]>0){ //Als de temperatuur negatief is, maak het zo dat de balken ook negatief staan
	...
	offy+=7;
	if(weerData->minimumtemperatuur[2]>0){ //Als de temperatuur negatief is, maak het zo dat de balken ook negatief staan
