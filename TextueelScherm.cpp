...
TextueelScherm::TextueelScherm( WeerData* weerData ){
	...
	//TODO: update labels met text, etc.

	//stelt achtergrond label in als main widget, en maakt alles zichtbaar
	this->setMain(achtergrond);
}

//TODO: Toevoegen variabelen die worden gebruikt met de data
